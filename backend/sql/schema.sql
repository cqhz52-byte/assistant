...
ALTER TABLE hospitals ADD COLUMN IF NOT EXISTS province VARCHAR(64) NOT NULL DEFAULT '';
ALTER TABLE hospitals ADD COLUMN IF NOT EXISTS city VARCHAR(64) NOT NULL DEFAULT '';
